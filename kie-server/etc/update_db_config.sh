...
sed -i "s/KIE_SERVER_ID/$KIE_SERVER_ID/" $CLI_FILE
sed -i "s,KIE_SERVER_CONTROLLER,$KIE_SERVER_CONTROLLER," $CLI_FILE
sed -i "s/KIE_SERVER_USER/$KIE_SERVER_USER/" $CLI_FILE
sed -i "s/KIE_SERVER_PWD/$KIE_SERVER_PWD/" $CLI_FILE
sed -i "s,KIE_SERVER_LOCATION,$KIE_SERVER_LOCATION," $CLI_FILE
sed -i "s/KIE_SERVER__CONTROLLER_USER/$KIE_SERVER_CONTROLLER_USER/" $CLI_FILE
sed -i "s/KIE_SERVER__CONTROLLER_PWD/$KIE_SERVER_CONTROLLER_PWD/" $CLI_FILE
